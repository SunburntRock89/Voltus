...
module.exports = async(client, msg, suffix, doc) => {
	...
	// {
		...
		emoji: "☑️",
		description: "Enables messages that are sent when a user leaves the server.",
		explanation: "Leave messages are sent in a channel when users leave the server.",
		dbEntry: "leaveEnabled",
		function: onOrOff,
	}, {
		name: "Leave channel",
		emoji: "🚶",
		description: "Change the channel that leave messages are sent in.",
		explanation: "Leave message channel configures the channel where join messages are sent to.",
		...
		name: "Leave Message",
		emoji: "👋",
		description: "The leave message is the message that is sent when someone joins the server.",
		explanation: "Changing the leave message will configure the message that is sent when a user leaves the server.",
		dbEntry: "leaveChannel",
		function: stringConfig,
	}, {
		name: "Go back",
